...
public class CategoriaResource {
	...
	public ResponseEntity<List<CategoriaDTO>> list(){
		...
		List<CategoriaDTO> lista = this.service.findAll().stream().map( obj -> new CategoriaDTO(obj))
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
		...
		Page<CategoriaDTO> lista = service.findPage(page, linesPerPage, orderBy, direction).map(obj -> new CategoriaDTO(obj));
		return ResponseEntity.ok().body(lista);
	}
}
